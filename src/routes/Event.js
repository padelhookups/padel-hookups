...
const Event = () => {
	...
	const { removeMixPlayed } = StatisticsActions();
	...
	const [createRandomPairsDisabled, setCreateRandomPairsDisabled] =
		useState(false);
												...
												<Button
													...
													onClick={async () => {
														...
														if (
															...
															alert(
																"Please ensure an even number of players."
															);
															return;
														}
														setCreateRandomPairsDisabled(
															true
														);
														await createPairsForEvent(
															filteredUsers,
															eventId
														);
														dispatch(
											...
											<Button
												...
												onClick={async () => {
													if (
														...
														alert(
															"No players available to create matches."
														);
														return;
													}
													if (
