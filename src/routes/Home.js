...
const Home = () => {
	...
	const [evtInscriptionDate, setEvtInscriptionDate] = useState(""); // store as ISO string for now
	...
	const PremierPadelForEveryOne = getBoolean(
		remoteConfig,
					...
					<Box
						...
						{evtType !== "Premier" ? (
							<FormControl fullWidth>
								<TextField
									...
									value={evtClass}
									onChange={(e) =>
										setEvtClass(e.target.value)
									}>
									{/* , '📚 Training' */}
									{["🏆 Tournament", "🤝 Friendly"].map(
										(t) => (
											<MenuItem key={t} value={t}>
												{t}
											</MenuItem>
								...
								<FormControl fullWidth>
									<Box
										...
										<TextField
											...
											value={evtStartMonth}
											onChange={(e) =>
												setEvtStartMonth(e.target.value)
											}
										/>
										<TextField
											fullWidth
						...
						<FormControl fullWidth>
							<TextField
								...
								onChange={(e) =>
									setEvtDescription(e.target.value)
								}
								autoComplete='off'
							/>
						</FormControl>
							...
							<FormControlLabel
								control={
									<Switch
										...
										onChange={(e) =>
											setHasWelcomeKit(e.target.checked)
										}
									/>
								}
							...
							<FormControlLabel
								control={
									<Switch
										checked={recordGames}
										onChange={(e) =>
											setRecordGames(e.target.checked)
										}
									/>
								}
								label='Record Games'
