...
import { Box, Chip, Container, Divider, Stack, Typography, Paper } from "@mui/material";
        ...
        <Paper elevation={1} sx={{ p: 2.5 }}>
          <Stack spacing={1.25}>
            <Typography
              ...
              textAlign="center"
            >
              No brackets available<br /> Create the pairs and then generate the tournament in details page
            </Typography>
          </Stack>
        </Paper>
      </Container>
                      ...
                      sx={{
                        ...
                        backgroundColor:
                          winnerId === match.opponent1.id
                            ...
                            : "transparent",
                        color:
                          winnerId === match.opponent1.id ? "white" : "inherit",
                      }}
                    >
                      {player1?.name || "TBD"}
                      <Typography
                      ...
                      sx={{
                        ...
                        backgroundColor:
                          winnerId === match.opponent2.id
                            ...
                            : "transparent",
                        color:
                          winnerId === match.opponent2.id ? "white" : "inherit",
                      }}
                    >
                      {player2?.name || "TBD"}
                      <Typography
